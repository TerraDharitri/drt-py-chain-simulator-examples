...
from dharitri_py_sdk.core import TransactionsFactoryConfig, TransferTransactionsFactory
...
def main():
    ...
    print(f"creating a transaction that sends 1rewa from {sender_bech32} to {receiver_bech32}")
